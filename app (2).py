...
DATA_DIR = "." # Changed from "/content/" to "." for Streamlit Cloud compatibility
...
def load_data():
    try:
        ...
        for df_name, file_name in file_names.items():
            ...
            # Adding debug prints to Streamlit's log
            st.warning(f"Debug: Attempting to load {file_name} from {full_path}. Exists: {os.path.exists(full_path)}") # Debug print
...
if summary_df is not None:
    ...
    # --- Model Performance Section ---
        ...
        # In a real app, you'd build this from your actual results dictionaries.
